  ...
  <div class="container-fluid">
    <div class="row justify-content-between">
      <div class="mb-4">
        <div class="text-head font-weight-bold h2 py-0 my-0 text-black">
            Dues, Pledges And Partnership Report
        </div>
        <div @click="goBack">
    ...
    <div class="row">
      <div class="col-md-12 px-0 s-18 fw-400 text-black">
        This reports provides a detailed list of all the Dues, pledges and partnership
        reports
      </div>
    </div>
    <div class="row grey-backg justify-content-center py-5 border-radius-8">
      <div class="col-sm-10 col-12">
        <div class="row">
          <div class="col-sm-12 col-md-6 pt-md-2 pr-md-0">
            <div>
          ...
          <div class="col-md-6 col-sm-12 mt-2 mt-md-0 pr-md-0">
          ...
          <div class="col-md-6 col-sm-12 mt-2 mt-md-0">
            <div class="p-field pt-md-2 p-col-12">
              <div>
                <label for="icon" class="fw-400 mb-0  text-dak s-14">Select Status</label>
              </div>
              <div>
                <SelectAllDropdown
          ...
          <div class="col-md-6 col-sm-12 mt-1 mt-md-0 pr-md-0">
          ...
          <div class="col-12 col-md-6 mt-2 d-flex justify-content-center">
            <el-button
              class="c-pointer mt-3 w-100 py-4"
              :color="primarycolor"
              round
              :loading="loading"
      ...
      <div class="row" :class="{ 'show-report': showReport, 'hide-report': !showReport }">
        <div class="col-12 round-border container-fluid d-flex mt-3 flex-wrap">
          <div class="col-12 col-md-6 col-lg-6">
            <OfferingColumnChart
              domId="chart1"
              title="Pledges and Partnership Report"
              distance="5"
              :titleMargin="10"
              :data="offeringDetail"
              subtitle="Pledges And Partnership Data"
          ...
          <table class="table remove-styles mt-0 table-header-area" id="table">
            ...
            <tbody class="font-weight-bold text-nowrap" style="font-size: small">
              <tr v-for="(item, index) in offeringInChurch" :key="index">
                ...
                <td>{{ item.contact }}</td>
                <td>
                  {{ item && item.currencySymbol ? item.currencySymbol : "" }}
            ...
            <tbody class="font-weight-bolder text-nowrap" style="font-size: small">
              <tr class="answer-row2">
                ...
                <td class="gross-total responsive-horizontalrule">
                  ...
                  {{
                    pledgesInNaira &&
                    pledgesInNaira.length > 0 &&
                    pledgesInNaira[0].currencySymbol === "₦"
                      ? pledgesInNaira[0].currencySymbol
                      : ""
                  }}
                  {{
                    sumTotal && sumTotal.amount ? sumTotal.amount.toLocaleString() : 0
                  }}.00
...
export default {
  ...
  setup() {
    ...
    const genarateReport = () => {
      ...
      axios
        .post("/api/Reports/pledges/getAllPledgesSearch", payload)
        .then((res) => {
          console.log(res.data, "ggfg");
          offeringInChurch.value = res.data.returnObject;
          pledgesInNaira.value = offeringInChurch.value.filter(
            (i) => i.currencySymbol === "₦"
          );
          pledgesInDollars.value = offeringInChurch.value.filter(
            (i) => i.currencySymbol === "$"
          );

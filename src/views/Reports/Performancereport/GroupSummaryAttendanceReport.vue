<template>
  <div class="container-fluid" @click="closeDropdownIfOpen">
    <div class="row justify-content-between">
      <div class="mb-4">
        <div class="text-head font-weight-bold h2 py-0 my-0 text-black ">Group Summary Attendance Report</div>
        <div @click="goBack">
    ...
    >
      <div class="col-md-10 col-12">
        <div class="row">
          <div class="col-sm-6">
            <div class="fw-400 mb-0  text-dak s-14">Select Event</div>
            <div class="mt-2">
              <el-select-v2
          ...
          <div class="col-sm-6">
            <div class="fw-400 mb-0  text-dak s-14">Select Group</div>
            <div class="mt-2">
              <button
          ...
          <div class="col-sm-6 mt-3">
            <div class="fw-400 mb-0  text-dak s-14">Start Date</div>
            <div class="mt-2">
              <el-date-picker
                v-model="startDate"
                type="date"
          ...
          <div class="col-sm-6 mt-3">
            <div class="fw-400 mb-0  text-dak s-14">End Date</div>
            <div class="mt-2">
              <el-date-picker
                v-model="endDate"
                type="date"
  ...
  >
    <div
      ...
      v-if="displayTitle"
    >
      <div class="text-head font-weight-bold h2">Group Summary Attendance Report</div>
    </div>
    ...
    const getAttendanceReport = async () => {
      ...
      try {
        let { data } = await axios.post(
          `api/Reports/events/GetCheckAttendanceSummaryReport`,
          payload
        );
        searched.value = true;
        loading.value = false;
    ...
    const getAllCustomFields = async () => {
      try {
        ...
        dynamicCustomFields.value = data
          .filter((i) => i.entityType === 5)
          .map((i) => {
            if (i.label.indexOf(" ") >= 0) {
              i.label = i.label.replace(/ /g, "_");
            }
            return i;
          });
      } catch (err) {

    ...
    <div class="container-top" :class="{ 'container-slim': lgAndUp || xlAndUp }">
        ...
        <form class="form">
                    ...
                    <el-dropdown trigger="click" class="w-100">
                        ...
                        <template #dropdown>
                            <el-dropdown-menu>
                                ...
                                <el-dropdown-item data-toggle="modal" data-target="#exampleModalCenter" class="text-center"
                                    divided><a
              ...
              >
                ...
                <div class="col-1 align-self-center">
                    <el-tooltip class="box-item" effect="dark" content="Delete" placement="bottom">
                        <el-icon :size="18" @click="showConfirmModal(item.id, index)">
                            <Delete />
                        </el-icon>
                    </el-tooltip>
                </div>
            ...
            <div class="col-8 col-md-5 offset-sm-1 offset-md-3 pl-0 offset-lg-4 mt-3">
                <el-button style="margin-left: -3px" round v-on:click.prevent="addContribution"
            ...
            <div class="row" v-if="false">
                <div class="col-10 col-md-12 mt-4">
                    <div class="d-flex">
                        ...
                        <hr style="width: 60%" />
                        <el-icon :class="{ 'rollIcon': templateDisplay, 'closeIcon': !templateDisplay }"
                    ...
                    <div class="row img-row hide-tem mt-4"
            ...
            <div class="row">
                ...
                <div class="col-12 col-sm-10 col-md-6 col-lg-5 offset-sm-1 offset-md-3 offset-lg-4 pl-0 mt-3">
                    <el-button class="button border-0 w-100 text-white" round :loading="loadingSave"
        ...
        <el-dialog v-model="displayResponsive" title="" :width="mdAndUp || lgAndUp || xlAndUp ? `50%` : `90%`">
            <div class="row">
                <div class="col-md-12">
                    <p>You have no income account to create a offering item, go to Chart of Account and click 'Update
                        Account' to update your accounts.</p>
                </div>
            </div>
            <template #footer>
                <!-- <Button label="No" icon="pi pi-times" @click="closeResponsive" class="p-button-text"/> -->
                <el-button round class="w-100 text-white primary-bg" label="Go to Chart Of Accounts"
                    @click="closeResponsive" autofocus>Go to Chart Of Accounts<el-icon>
                        <Check />
                    </el-icon> </el-button>
            </template>
        </el-dialog>
...
export default {
    ...
    setup(prop, { emit }) {
        ...
        // onMounted(() =>{
        //     if (paymentGateWaysDb.value) {
        //         getGateWays()
        //         console.log( paymentGateWaysDb.value , 'kkkk'); 
        //     }
        ...
        watchEffect(() => {
            ...
            //    console.log( gateways.value , 'kkkdddk'); 
            //    console.log( paymentGateWaysDb.value , 'wwqwqw'); 
            //    if (gateways.value && gateways.value[0] && gateways.value[0].isChecked == false) {
            //     return gateways.value[0].isChecked = true;
            //    }
            //    if (gateways.value && gateways.value[1] && gateways.value[1].isChecked == false) {
            //     return gateways.value[1].isChecked = true;
            //    }
        })
        ...
        return {
            contributionItems, newContribution, addContribution, lgAndUp, mdAndUp, xlAndUp, filteredBanks, setBank, gatewayNotification,

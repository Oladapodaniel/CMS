  ...
  <div class="container-fluid container-top" @click="hideModals">
          ...
          <div class="text-center text-sm-right col-sm-7">
            <div class="row">
              <div class="col-md-12 d-lg-flex justify-content-end">
                ...
                <el-button class="text-white border-0 ml-3" @click="post" round :color="primarycolor"
                  :loading="loading">
          ...
          <div class="col-12 col-sm-8 offset-sm-3 offset-md-0 col-md-5 dropdown-container">
            <div class="select-elem-con pointer ofering" id="eventCategorySelectElem"
              ...
              <span class="ofering">
                ...
                &nbsp;&nbsp;&nbsp;Select Category</span><span class="mt-1">
    ...
    " size="large" />
            ...
            <div class="col-3 col-sm-2 col-lg-1">
              <div class="currency py-2 pointer d-flex justify-content-around align-items-center close-modal"
    ...
    name, id, cashaccount, amount
        ...
        <div class="attendance-body stretch" id="offeringBody" v-for="(item, index) in expenseItem" :key="index">
          <div class="row">
            ...
            <div class="col-3 col-sm-4 col-lg-2">
              <el-select-v2 v-model="item.creditAccountID" class="w-100 font-weight-normal"
                :options="cashAccounts.map((i) => ({ label: i.text, value: i.id }))" size="large" />
            </div>
    ...
    this.expenseItem.reduce((a, b) => {
      ...
      <div class="form col-12 col-sm-12 offset-md-0 col-md-12">
        ...
        <div class="row form-body close-slide3" :class="{ 'slide-down3': showForm3 }">
          ...
          <div class="col-12 col-sm-3 add-first-timer pointer ml-sm-2" v-if="routeParams"
            @click="firstTimerImport = true">Import First Timers</div>
          <div class="col-12 mt-3 mt-sm-0 col-sm-3 ml-sm-2 add-new-convert pointer" id="modalTogglerFirstTimers"
            data-toggle="modal" data-target="#exampleModalNewConvert">
            Add New Converts
          </div>
          <!-- First timer table -->
              ...
              <form>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-3 mb-4 offset-sm-3 pr-sm-0">
                    <el-select-v2 v-model="valueMarital" @change="dropDownMarital" :options="maritalStatusArr.map((i) => ({ label: i.value, value: i.id }))
            ...
            <div class="container">
              <form>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-3 mb-4 offset-sm-3 pr-sm-0">
                    <el-select-v2 v-model="firstTimersObj.valueMarital" @change="dropDownMaritalNewConvert" :options="maritalStatusArr.map((i) => ({ label: i.value, value: i.id }))
    " placeholder="Marital Status" class="w-100" size="large" />
                  </div>
          ...
          <div class="modal-body">
            <div class="container">
              <div class="row">
                ...
                <div class="col-lg-5 col-sm-12 mt-3">
                  <el-select-v2 v-model="selectedCashAccount" :options="cashBankAccount.map((i) => ({ label: i.text, value: i.id }))
    " placeholder="Select" size="large" class="w-100" />
                </div>
              ...
              <div v-if="applyRem">
                <div class="row" v-for="(item, index) in remitance" :key="index">
                  ...
                  <div class="col-lg-5 col-sm-12 mt-5">
                    <el-select-v2 v-model="itemAccountID" @change="setIncomeAccount(index)" :options="incomeAccount.map((i) => ({ label: i.text, value: i.id }))
    " placeholder="Select" size="large" class="w-100" />
                  </div>

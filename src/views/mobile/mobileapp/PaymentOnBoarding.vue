...
<Toast></Toast>
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="col-12 col-sm-10 offset-sm-1 offset-md-0 col-md-6 col-lg-12 pl-md-0 mt-3" style="height: 43px;">
        ...
        <div class="col-md-12">
            <div  class="mt-3 p-0 col-10 offset-sm-1 offset-md-0 col-md-3 col-lg-6  align-self-center">
                <div>Enter account number</div>
            </div>
            <div class="col-12 col-sm-10 offset-sm-1 offset-md-0 col-md-6 col-lg-12 pl-md-0 mt-3" style="height: 43px;">
                <input class="form-control h-100" type="number" v-model="form.accountNumber" @blur="resolveCustomerDetail">
            </div>
        </div>
        ...
        <div class="col-md-12">
            <div v-if="accountName" class="mt-3 p-0 col-10 offset-sm-1 offset-md-0 col-md-3 col-lg-4  align-self-center">
                <div>Account Name</div>
            </div>
            <div v-if="form.accountName" class="col-12 col-sm-10 offset-sm-1 offset-md-0 col-md-6 col-lg-12 pl-md-0 mt-3" style="height: 43px;">
                <input type="text" v-model="form.accountName" placeholder="Account name" ref="accNameRef" class="form-control h-100" />
                <div class="mt-1">
       ...
       const submitForm = () => {
         ...
         const resolveCustomerDetail = async() => {
            ...
            try {
                ...
                let { data } = await axio.get(`https://api.paystack.co/bank/resolve?account_number=${form.value.accountNumber}&bank_code=${selectedBank.value.code}`, header)
            ...
            console.log(selectedBank.value.code, form.value.accountNumber, 'Acount Name')
        }
        return {
            selectedBank, nigerianBanks, resolveCustomerDetail, loading, form, submitForm
         }
    }
}
</script>

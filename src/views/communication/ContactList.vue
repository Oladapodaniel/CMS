        ...
        <div class="container-fluid px-0">
          <div class="row px-0">
            <div class="col-md-12 px-0">
              <div class="text-head font-weight-bold text-black h2">Contact List</div>
              <div class="grey-backg py-2 border-radius-8 col-md-3">
                <router-link
                  to="/tenant/sms/sent"
                  class="text-decoration-none s-18 text-dak"
                >
                  <span class="linear-gradient">SMS> Contact List</span>
                </router-link>
              </div>
              <div class="row align-items-center mt-4 ">
                <div class="col-md-12">
                  <router-link to="/tenant/sms/addgroup" class="create-">
                    <el-button  round class="border-0"
                      ><span class="primary-text s-16" >Create new group</span></el-button
                    >
                  </router-link>
                  <!-- <router-link to="/tenant/sms/addgroup" class="create-btn">
                    <el-button color="#EBEFF4" round class="head-btn"
                      >Create new group</el-button
                    >
                  </router-link> -->
                </div>
              </div>
              <div class="table-option mt-3" v-if="markedContact.length > 0">

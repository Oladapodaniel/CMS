    ...
    <div class="col-md-12">
      ...
      >
        ...
        <div class="col-6 col-md-2 text-right">
          <el-icon data-toggle="modal" data-target="#expModal" :size="20" @click="editAccount(item, itm)" class="c-pointer mx-2"><EditPen /></el-icon>
          ...
          <div class="modal-content">
            <div class="modal-header">
              ...
              <el-button
                ...
                aria-label="Close"
              >
                <span aria-hidden="true" class="mt-1" ref="closeAccountModalBtn"><el-icon :size="20"><Close /></el-icon></span>
              </el-button>
            </div>
      ...
      ElMessageBox.confirm(
        ...
        .then( async () => {
          try {
                ...
                emit("expense-deleted", index, indx);
              } catch (error) {
                ElMessage({
                  type: "error",

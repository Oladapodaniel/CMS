            ...
            <div class="col-4 d-flex justify-content-end">
              <div href="#" style="cursor: pointer" class="mr-3" @click="checkForToken">{{
                Object.keys(userData).length
                  > 0 ? userData.email ? userData.email : userData.name : "Sign In"
                ...
                <div class="col-sm-10 col-md-8 mx-auto form-area shadow p-md-5 mb-5 bg-white rounded MIDDLE"
                  ...
                  <div class="row">
                    ...
                    <div class="col-12 my-3">
                      ...
                      <el-input class="text-left imp1" type="text" v-model="amount" style="height: 39px"
                  ...
                  <section class="col-md-12 mt-3 px-0" v-if="!hideTabOne">
                    <div class="row">
                      ...
                      <div class="col-md-6 d-flex flex-row mt-n2">
                        <input type="date" class="form-control fone p-3 imp1" v-model="date" />
                      </div>
                    </div>
                  </section>
                  <!-- end of date area -->
                        ...
                        <div class="col-md-6">
                          <div class="row">
                            <div class="col-md-12 mx-auto my-2 px-0 px-2">
                              ...
                              <el-input class="text-left imp1" type="text" placeholder="Enter your name" v-model="name"
                                style="height: 39px" />
                            </div>
                          </div>
                        </div>
                        ...
                        <div class="col-md-6">
                          <div class="row">
                            <div class="col-md-12 mx-auto my-2 px-0 px-2">
                              ...
                              <el-input class="text-left imp1" type="text" v-model="phone"
                                placeholder="Enter your phone number" style="height: 39px" />
                            </div>
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="col-md-6">
                        <div class="row">
                          <div class="col-md-12 mx-auto my-2 px-0 px-2">
                            ...
                            <el-input class="text-left imp1" type="password" v-model="signInPassword" />
                          </div>
                        </div>
                      </div>
              ...
              <div class="row">
                ...
                <div class="col-md-6 d-flex justify-content-center">
                  ...
                  <div class="col-1 px-1">
                    <img class="w-100" src="../../../assets/1s519863150871.png" alt="" />
                  </div>

<template>
  <main :class="{ 'container-wide': lgAndUp || xlAndUp }">
    <div class="container-top">
      ...
      >
        ...
        <div class="d-flex flex-wrap flex-sm-nowrap mt-3 mt-sm-0">
          <div class="d-flex mt-1 w-100 cursor-pointer" @click="watchVideo">
          ...
          >
            ...
            <template #dropdown>
              <el-dropdown-menu>
                <el-dropdown-item>
                  <router-link :to="`/tenant/firsttimerslist`" class="no-decoration text-black">
                  First Timer
                  </router-link>
                </el-dropdown-item>
                <el-dropdown-item >
                ...
                <el-dropdown-item class="text-black">
                  <router-link :to="`/tenant/people`" class="no-decoration text-black">
                  Member
                  </router-link>
                </el-dropdown-item>
              </el-dropdown-menu>
          ...
          <el-dropdown
            trigger="click"
            class="align-items-center primary-bg ml-md-3 ml-0 default-btn  p-0 m-0 border"
            style="height: 2.2rem;"
          >
            <span
              class="el-dropdown-link w-100 d-flex align-items-center justify-content-center text-white font-weight-600"
            >
              Add new
              <el-icon class="el-icon--right">
                <arrow-down />
            ...
            <template #dropdown>
              <el-dropdown-menu>
                <el-dropdown-item >
                  <router-link :to="`/tenant/people/addfirsttimer`" class="decoration-none text-black">
                  First Timer
                  </router-link>
                </el-dropdown-item>
                <el-dropdown-item class="text-black">
                  <router-link :to="`/tenant/people/addnewconvert`" class="no-decoration text-black">
                  New Convert
                  </router-link>
                </el-dropdown-item>
                <el-dropdown-item class="text-black">
                  <router-link :to="`/tenant/people/add`" class="no-decoration text-black">
                  Member
                  </router-link>
                </el-dropdown-item>
              </el-dropdown-menu>
    ...
    <div class="row" v-if="false">
      ...
      <div class="col-md-10 pl-0 py-md-4 mt-3" v-if="route.fullPath == '/tenant/contact'">
        <div class="font-weight-bold">
          Share the link to your members to enable them to add their details to your
          church .
        </div>
    ...
    >
      <div class="d-flex align-items-center flex-column">
        ...
        <div class="s-20">Scan the Code below with your smartphone</div>
      </div>
